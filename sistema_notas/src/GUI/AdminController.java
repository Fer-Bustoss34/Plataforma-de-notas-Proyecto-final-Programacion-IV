...
public class AdminController implements ControladorBase {
    ...
    private void onRegistrarEstudiante() {
        try {
            ...
            boolean ok = sistema.registrarEstudiante(new Estudiante(ced, nom, ape, cor, con, sem));
            if (ok) {
                ...
                campoEstCorreo.clear(); campoEstContrasena.clear(); campoEstSemestre.clear();
            } else {
    ...
    private void onRegistrarDocente() {
        ...
        boolean ok = sistema.registrarDocente(new Docente(ced, nom, ape, cor, con, cod, esp));
        if (ok) {
            ...
            campoDocCorreo.clear(); campoDocContrasena.clear(); campoDocCodigo.clear(); campoDocEspecialidad.clear();
        } else {
